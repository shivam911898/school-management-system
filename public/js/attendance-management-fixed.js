  ...
  try {
    ...
    async function loadStats() {
      try {
        ...
        document.getElementById('totalStudentsStat').textContent = studentsResponse.data.pagination.total || 0;
    ...
    function loadExistingAttendance() {
      ...
      // Load existing attendance for selected date and subject
    ...
    function setDefaultDate() {
      // Use a date that has actual test data (around 2026-04-10)
      const testDataDate = new Date('2026-04-10').toISOString().split('T')[0];
      document.getElementById('dateSelect').value = testDataDate;
    }
    ...
    ui.toast('Failed to load attendance management', 'error');
  }
});
